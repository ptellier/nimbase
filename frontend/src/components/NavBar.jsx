        ...
        >
          <Hide below="md">
            <Link to={"/"} className="nav-item">
              <img src={NimbaseIcon} className="nav-bar-logo" alt="logo" />
            </Link>
          </Hide>
          <Link to={"/explore"} className="nav-item">
            <Text fontSize={FONT_SIZES}>Explore</Text>
          </Link>
          {username ? (
            <>
              <Link to={"/project/dashboard"} className="nav-item">
                <Text fontSize={FONT_SIZES}>Projects</Text>
              </Link>
            </>
          ) : (
            <>
              <Link to={"/signup"} className="nav-item">
                <Text fontSize={FONT_SIZES}>Sign-up</Text>
              </Link>
              <Link to={"/login"} className="nav-item">
                <Text fontSize={FONT_SIZES}>Login</Text>
              </Link>
            </>
          )}
        </HStack>
          ...
          >
            ...
            <Menu>
              <MenuButton
                ...
                _focus={{}}
              >
                <Text fontSize={FONT_SIZES} className="nav-item">
                  {username} <FontAwesomeIcon icon={faChevronDown} size="xs" />
                </Text>
              </MenuButton>
              <MenuList>
