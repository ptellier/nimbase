...
const SKEL_CLRS = {
  startColor: "rgb(234,200,205)",
  endColor: "rgb(188,195,216)",
};
          ...
          {projects.map((project, i) =>
            project.url ? (
              <a
                href={project.url}
                target="_blank"
                key={"explore-project-" + i}
              >
                <div className="explore-project" style={{ cursor: "pointer" }}>
                  <Heading as="h2" ml="10px" fontSize="18px" align="left">
                    {project.name}
                  </Heading>
                  <div
                  ...
                  <Text as="p" ml="10px" className="explore-project-owner">
                    {"Owner: " + project.owner}
                  </Text>
                  <Tooltip label={project.description} bg="white" color="black">
                    <Box ml="10px">
                      <Text as="p" className="explore-project-desc">
                        {project.description}
                      </Text>
                    </Box>
                  </Tooltip>
